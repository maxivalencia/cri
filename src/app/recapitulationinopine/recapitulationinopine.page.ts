...
@Component({
  selector: 'app-recapitulationinopine',
  templateUrl: './recapitulationinopine.page.html',
  styleUrls: ['./recapitulationinopine.page.scss'],
})
export class RecapitulationinopinePage implements OnInit {
